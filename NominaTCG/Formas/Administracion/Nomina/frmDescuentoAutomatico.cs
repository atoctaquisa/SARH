...
namespace NominaTCG
{
    public partial class FrmDescuentoAutomatico : Form
    {
        #region Properties
        ...
        private static FrmDescuentoAutomatico _instancia;
        public static FrmDescuentoAutomatico Instancia
        {
            get
            {
                if (_instancia == null)
                    _instancia = new FrmDescuentoAutomatico();
                return _instancia;
            }
            set
            {
        ...
        private void FrmDescuentoAutomatico_FormClosing(object sender, FormClosingEventArgs e)
        {
            _instancia = null;
